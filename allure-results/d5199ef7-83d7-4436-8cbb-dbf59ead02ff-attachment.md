...
Call log:
  - waiting for getByRole('checkbox', { name: 'Playwright' })
...
> 12 |      await page.getByRole('checkbox', { name: 'Playwright' }).check();
     |                                                               ^ Error: locator.check: Test timeout of 30000ms exceeded.
  13 |      await page.getByRole('checkbox', { name: 'Cypress' }).check();
  14 |      await page.getByRole('checkbox', { name: 'Selenium' }).check();
  15 | 
  16 | 
  17 | 
  18 | 
