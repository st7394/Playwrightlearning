...
Locator: locator('//div[@data-testid="experience-trigger"]')
...
Call log:
  ...
  - waiting for locator('//div[@data-testid="experience-trigger"]')
...
```ts
  ...
  18 | 
  19 |     await expect(page.locator('//div[@id="framework-shell"]')).toContainText('Next.js');
