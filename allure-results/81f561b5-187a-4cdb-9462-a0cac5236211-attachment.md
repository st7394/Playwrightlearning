...
Call log:
  - waiting for locator('[class=\'W(100%) Py(14px) input-text invalid-input\']')
...
> 6  |       await page.locator("[class='W(100%) Py(14px) input-text invalid-input']").fill("abc@gmail.com");
     |                                                                                 ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  7  |       await page.locator("#gdpr_consent_checkbox").check();
