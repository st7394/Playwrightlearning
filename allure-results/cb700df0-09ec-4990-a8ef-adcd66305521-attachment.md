...
Locator:  getByText('Paste', { exact: true }).first()
Expected: "true"
Received: ""
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByText('Paste', { exact: true }).first()
    9 × locator resolved to <em>Paste</em>
...
```ts
  ...
  17 |         button: 'right',
  18 |     });
  19 |     let poption:Locator = page.getByText('Paste', { exact: true }).first();
