...
Call log:
  - waiting for getByTestId('tool-cypress')
            ...
            - generic [ref=e317]:
              ...
              - generic "Automation tools" [ref=e319]:
                ...
                - generic [ref=e324] [cursor=pointer]:
                  - checkbox "Selenium Webdriver" [checked] [active] [ref=e325]
...
```ts
  ...
  17 |         await page.getByRole('textbox', { name: 'First Name' }).fill('Saumitra');
  18 |         await page.getByRole('textbox', { name: 'Last Name' }).fill('Tripathi');
  19 |     });
  20 | 
  ...
  30 |         await page.locator("#years-experience").selectOption('7');
