...
Locator: locator('//div[@data-testid="=dropdown-experience · experience-trigger"]')
Expected substring: "Mid-level (4-6 years)"
Timeout: 5000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('//div[@data-testid="=dropdown-experience · experience-trigger"]')
        ...
        - generic [ref=e241]:
          ...
          - generic [ref=e258]:
            ...
            - button "Web framework" [ref=e261] [cursor=pointer]:
              - generic [ref=e262]: Choose your preferred web framework
              - img [ref=e263]
            - generic [ref=e265]:
              - generic [ref=e266]:
                - generic [ref=e267]: id
...
```ts
  ...
  15 | 
  16 |     
> 17 |     await expect(page.locator('//div[@data-testid="=dropdown-experience · experience-trigger"]')).toContainText('Mid-level (4-6 years)');
     |                                                                                                   ^ Error: expect(locator).toContainText(expected) failed
  18 | 
  19 | 
  20 | })
