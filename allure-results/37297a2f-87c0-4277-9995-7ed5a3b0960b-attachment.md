...
Locator: locator('//div[@data-testid="framework-trigger"]')
...
Call log:
  ...
  - waiting for locator('//div[@data-testid="framework-trigger"]')
...
```ts
  ...
  18 | 
> 19 |     await expect(page.locator('//div[@data-testid="framework-trigger"]')).toContainText('Next.js');
     |                                                                           ^ Error: expect(locator).toContainText(expected) failed
