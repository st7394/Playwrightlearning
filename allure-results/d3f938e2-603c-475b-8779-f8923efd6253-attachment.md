...
Call log:
  - waiting for locator('//div[@data-testid=\'rs-multi-input\']')
        ...
        - generic [ref=e243]:
          ...
          - generic [ref=e270]:
            ...
            - generic [ref=e289]:
              ...
              - generic [ref=e292]:
                - generic [ref=e293]: chip
                - text: =tta-rs__multi-value
              - generic [ref=e294]:
                - generic [ref=e295]: remove
                - text: =tta-rs__multi-value__remove
          - generic [ref=e296]:
            - generic [ref=e297]:
              - heading "③ Creatable multi — type and Enter" [level=2] [ref=e298]
              - generic [ref=e299]: Add new options
            - paragraph [ref=e300]:
            ...
            - generic [ref=e303]:
              - generic [ref=e304]:
                - generic [ref=e305]: Add skill tags…
                - textbox "Add a tag" [ref=e307]
              - generic [ref=e308]:
                - button "Clear values" [ref=e309] [cursor=pointer]:
                  - img [ref=e310]
                - img [ref=e314]
            - generic [ref=e316]:
              - generic [ref=e317]:
                - generic [ref=e318]: data-testid
                - text: =rs-creatable · rs-creatable-input
              - generic [ref=e319]:
                - generic [ref=e320]: create
                - text: =press Enter
          - generic [ref=e321]:
            - generic [ref=e322]:
              - heading "④ Grouped — categorised options" [level=2] [ref=e323]
              - generic [ref=e324]: Groups
            - paragraph [ref=e325]: Options are split into labelled groups. Practise reaching an option inside a specific group heading.
            - generic [ref=e327]:
              - generic [ref=e328]:
                - generic [ref=e329]: Pick a deployment target…
                - textbox "Filter options" [ref=e331]
              - img [ref=e335]
            - generic [ref=e337]:
              - generic [ref=e338]:
                - generic [ref=e339]: data-testid
                - text: =rs-grouped
              - generic [ref=e340]:
                - generic [ref=e341]: group
                - text: =tta-rs__group · data-group=Cloud / Edge / Self-hosted
          - generic [ref=e342]:
            - generic [ref=e343]:
              - heading "⑤ Async — fetched on type" [level=2] [ref=e344]
              - generic [ref=e345]: 600ms latency
            - paragraph [ref=e346]:
              - text: Type a city name. Results load after a simulated 600ms network call. Practise
              - code [ref=e347]: page.waitForResponse
              - text: patterns or just await a visible option.
            - generic [ref=e349]:
              - generic [ref=e350]:
                - generic [ref=e351]: Type to search cities…
                - textbox "Search cities" [ref=e353]
              - img [ref=e356]
            - generic [ref=e358]:
              - generic [ref=e359]:
                - generic [ref=e360]: data-testid
                - text: =rs-async · rs-async-input · rs-async-menu
              - generic [ref=e361]:
                - generic [ref=e362]: state
                - text: =loading / no-results / results
          - generic [ref=e363]: "{ \"rs-single\": \"Cypress\", \"rs-multi\": [], \"rs-creatable\": [], \"rs-grouped\": null, \"rs-async\": null }"
        - complementary [ref=e364]:
          - generic [ref=e365]:
            - heading "What students should practise" [level=3] [ref=e366]
            - list [ref=e367]:
              - listitem [ref=e368]:
                - text: Click
                - code [ref=e369]: .tta-rs__control
                - text: to open, then click
                - code [ref=e370]: .tta-rs__option
                - text: by visible text.
              - listitem [ref=e371]:
                - text: Type into
                - code [ref=e372]: .tta-rs__input-container input
                - text: to filter options.
              - listitem [ref=e373]:
                - text: "Multi: remove a chip via its"
                - code [ref=e374]: .tta-rs__multi-value__remove
                - text: button.
              - listitem [ref=e375]: "Creatable: type a brand-new value and press Enter; assert the chip appears."
              - listitem [ref=e376]:
                - text: "Grouped: scope a query under a specific"
                - code [ref=e377]: .tta-rs__group[data-group="Edge"]
                - text: .
              - listitem [ref=e378]: "Async: wait for the loading notice to disappear, then click the result."
          - group [ref=e379]:
            - generic "Playwright solutions One snippet per variant. Show solution" [ref=e380] [cursor=pointer]:
              - img [ref=e382]
              - generic [ref=e384]:
                - strong [ref=e385]: Playwright solutions
                - generic [ref=e386]: One snippet per variant.
              - generic [ref=e387]: Show solution
```
...
```ts
  ...
  10 | 
> 11 |     await page.locator("//div[@data-testid='rs-multi-input']").click();
     |                                                                ^ Error: locator.click: Test timeout of 30000ms exceeded.
  12 |     await page.getByText("PyTest", { exact: true }).click();
  13 |     await page.getByText("Cucumber", { exact: true }).click();
